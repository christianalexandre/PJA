...
class AddFragment : Fragment() {
    ...
    private fun setupInputLayoutsListener() {
        ...
        var editText = binding?.inputLayoutAddTitle?.editText
        editText?.addTextChangedListener(addViewModel?.maskTaskTitle(editText))
        editText?.addTextChangedListener(addViewModel?.disableErrorTaskTitle(binding?.inputLayoutAddTitle, requireContext()))

        editText = binding?.inputLayoutAddContent?.editText
        editText?.addTextChangedListener(addViewModel?.maskTaskContent(editText))
